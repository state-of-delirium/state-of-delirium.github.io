---
author: "Vishnu"
title: Stupidity is the System
excerpt: "Despite spending hours every day surrounded by information, I feel less capable of thinking than I used to."
thumb: 
...
A specific characteristic that arises from these constraints is “stupidity”. Though the term requires clarification: by stupidity I don’t mean a lack of intelligence or thought, it's a system of incentives, affects, and repetitions that actively resists cognition, it’s the condition in which thinking is continually displaced by the demand to respond and allows the system to scale. 

I wouldn’t call it something that was done completely intentionally by these companies, but I would argue that it is simply a byproduct that they decided to take advantage of. It's in between the incidental and accidental side effects of rapid digitization and the growing media ecosystem. My fear here is that the system is being architected for this and that we will reach a point where my problems are going to stop being a failure of discourse and will simply be the algorithmic optimization for maximum reach and minimum thought. 

It is inevitable that stupidity is going to be structural, procedural and encoded into the DNA of platforms as a strategy.

<h2 class="dotted-underline-1">It's Too Much</h2>

So let’s begin with this premise: the platforms we use are ideological systems designed to habituate this particular mode of thinking. They are reactive, if I open Instagram and go to Reels I am provided with ten ways to react to the given reel: “like,” “comment,” “share,” “repost,” “save,” “send,” “follow” the creator, go to the creator’s account, and, if I click the three dots, I can “remix,” “sequence,” (though not relevant, horrendously enough “autoscroll”)

I’m going to introduce the concept of an “infocracy” Byung Chul Han here: In a traditional dictatorship information is suppressed to control people; whereas in a digital infocracy people are drowned in information. This results in transparency fatigue (exhaustion produced by infinite access). There are a lot of reasons to justify the fact that we are currently going through what would be a mix of the traditional dictatorship and a digital infocracy, because we are living at a point in time where a handful of people control almost all of the media[^1] that gets passed around, and we are actively watching the suppression of it while also seeing the cognitive overload that the massive amounts of information online are causing.

[^1]: the platform infrastructures through which information is distributed, and algorithmically ranked
...
So considering this misreading, during an information overload the content that requires interpretation is at a disadvantage, so the only content that survives is the content that resists interpretation, because there is something so narcotically satisfying about clean, thoughtless information, and how it slips past the faculties of judgment and straight into the bloodstream. That satisfaction is unfortunately directly proportional to virality, because what is virality but the weaponization of stupidity for maximum circulation.

<h2 class="dotted-underline-1">Circulation</h2>

Now that circulation came into the picture, inevitably speed became the dominant value, and a side effect of that is that if brought along hostility to slowness and nuance. Understanding is supposed to be a slow dialogical process, but on the internet slowness for understanding is failure. Dialogue is inefficient but this is a terrible path that we are on because a tweet cannot sustain contradiction, a TikTok cannot hold an argument, and a headline cannot express nuance. The very formats through which we now engage with the world are structurally hostile to ambiguity of any kind. Interpretation is always infinite if we allow for it to be infinite by giving it space and time.
...
Speed follows circulation as its condition. That’s the death of duration and many choices seem to point to this “death”: Instagram copying the “story” idea from Snapchat, or YouTube rolling out short-form videos very quickly after TikTok’s success with them, or marketing the idea that asking AI for an answer is infinitely faster than searching things up using a web browser.
...
[^2]: A simple experiment, if you will: next time you’re scrolling on any platform, try to recall what you saw five posts ago (I myself have failed this almost every time).

<h2 class="dotted-underline-1">The Role of AI (because people <i>totally</i> aren’t talking about AI enough)</h2>

When I open a search engine, whether it's for the most trivial of searches or some extremely complex ideas, I still need to piece fragments in my mind together and I still have to synthesize my ideas in a coherent way that will fetch me the responses I want. With AI that synthesizing and thinking isn't required because AI allows for a lot of vagueness when prompting. And I am not trying to indict tools, because humans have always externalized cognition: writing replaced memory, calculators replaced arithmetic, or search engines replaced recall. Those tools still required questions to be formed clearly enough to search/ write/ calculate, and they required a conceptual structure inside the mind before they became useful.
...
Because why should I maintain a deep internal archive in my mind when an external one responds instantly? Why should I labor through any difficulty when a model can simulate mastery much and almost infinitively more easily? Stupidity is the rational response to this environment that penalizes slowness and beyond surface level thinking, an environment where we are being disincentivized from exercising thought.

That’s the current evolution of the system I’ve been describing.
